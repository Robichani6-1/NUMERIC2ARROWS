...
print('NUMERIC2ARROWS: Creado por Robichani6-1 (Transportes Chancleta)')
yes = ["sí", "si", "s", "y", "yes"]
no = ["no", "n"]
response = input("¿Quieres mover cámara 0 con las flechas y no con el teclado numérico? (S/N)")
...
def change_values(file):
    ...
    with open(file, 'w') as f:
        f.writelines(lines)
        print('[+] Ya puedes mover la cámara 0 con las flechas.')
